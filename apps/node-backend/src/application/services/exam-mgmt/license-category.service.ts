...
export class LicenseCategoryService implements ILicenseCategoryService {
     ...
     */
    public async createCategory(dto: CreateLicenseCategoryRequestDTO): Promise<ILicenseCategoryResponseDTO> {
     ...
     */
    public async updateCategory(id: string, dto: UpdateLicenseCategoryRequestDTO): Promise<ILicenseCategoryResponseDTO> {
     ...
     */
    public async restoreCategory(id: string): Promise<ILicenseCategoryResponseDTO> {
