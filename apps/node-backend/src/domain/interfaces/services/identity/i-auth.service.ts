...
export interface IAuthService {
   ...
   * @returns {Promise<ILoginResponseDTO>} Đối tượng chứa thông tin hồ sơ người dùng và các mã thông báo truy cập.
   */
  login(dto: LoginRequestDTO): Promise<ILoginResponseDTO>;
