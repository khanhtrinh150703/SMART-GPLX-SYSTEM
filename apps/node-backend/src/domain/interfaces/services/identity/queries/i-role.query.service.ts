...
export interface IRoleQueryService {
   ...
   * @returns {Promise<ISelectionResponseDTO[]>} Danh sách Role định dạng selection (Value: ID, Label: Name).
   */
  getRoleSelections(): Promise<ISelectionResponseDTO[]>;
}