import { ITokenPayload } from '@/application/dtos/response/auth/token/token-payload.respone.dto';
...
export interface ITokenManager {
   ...
   * @param {ITokenPayload} payload - Dữ liệu chứa thông tin định danh phiên làm việc cần hủy bỏ.
   * @returns {Promise<void>}
   */
  revokeTokenByPayLoad(payload: ITokenPayload): Promise<void>;
