...
export interface IQuestionQueryService {
     ...
     */
    getPaginatedQuestions(query: QuestionsAdminQueryDto): Promise<PaginatedResult<IQuestionAdminResponseDTO>>
     ...
     */
    getQuestionsSummary(query: GetSelectionPoolDto): Promise<IExamQuestionSummaryResponseDTO[]>;
}