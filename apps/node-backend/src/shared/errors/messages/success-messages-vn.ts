...
export class Message {
  ...
  static readonly AUTH = {
    OTP_EMAIL:
      "Mã xác thực (OTP code) đã được gửi đến email của bạn. Vui lòng kiểm tra.",
  ...
  static readonly USER = {
    ...
    ADMIN_UPDATE_SUCCESS:
      "Quản trị viên đã cập nhật thông tin tài khoản thành công.",
  ...
  static readonly QUESTION = {
    ...
    FETCH_SUMMARY_SUCCESS: "Lấy danh sách câu hỏi tóm tắt thành công.",
  } as const;
  ...
  static readonly IMPORT = {
    ...
    CHUNK_UPLOAD_SUCCESS: (index: number | string) =>
      `Đã nhận thành công mảnh dữ liệu thứ ${index}`,
    COMPLETE_SUCCESS:
      "Tất cả các mảnh đã được nhận. Hệ thống đang tiến hành xử lý ngầm.",
  ...
  static readonly EXAM = {
    ...
    DETAIL_SUCCESS: "Tải chi tiết bộ đề thành công.",
  } as const;
  ...
  static readonly SESSION = {
    ...
    DELETE_SUCCESS: "Xóa phiên làm việc thành công",
  } as const;

  static readonly RANK = {
    FETCH_SUCCESS: "Lấy danh sách bảng xếp hạng thành công.",
    FETCH_ONE_SUCCESS: "Lấy thông tin hạng thành công.",
    CREATE_SUCCESS: "Tạo hạng mới thành công.",
