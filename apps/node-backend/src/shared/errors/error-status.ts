...
export const ErrorStatus: Record<ErrorCodeType, number> = {
  ...
  [ErrorCode.CHAPTER.INVALID_CODE]: 400, // Bad Request
  ...
  [ErrorCode.QUESTION.IS_CRITICAL_INVALID]: 400,

  // --- 4xx: Data Lifecycle & Integrity ---
  [ErrorCode.QUESTION.NOT_FOUND]: 404,
  [ErrorCode.QUESTION.EMPTY_BANK]: 404,
  [ErrorCode.QUESTION.INCOMPLETE_DATA_SET]: 409, // Xung đột do thiếu dữ liệu để thực hiện logic
  [ErrorCode.QUESTION.ALREADY_EXISTS]: 409,
  [ErrorCode.QUESTION.DELETE_CRITICAL_RESTRICTED]: 403,

  // --- 5xx: System Errors ---
  [ErrorCode.QUESTION.ANSWERS_SYNC_FAILED]: 500,
  ...
  [ErrorCode.MATRIX.TOTAL_PERCENTAGE_NOT_100]: 400,
  [ErrorCode.MATRIX.CHAPTER_ID_REQUIRED]: 400,
  [ErrorCode.MATRIX.CHAPTER_PERCENTAGE_OUT_OF_RANGE]: 400,
  ...
  [ErrorCode.MATRIX.TOO_MANY_CHAPTERS_FOR_TOTAL]: 400,
  [ErrorCode.MATRIX.MIN_CRITICAL_REQUIRED]: 400,
  [ErrorCode.MATRIX.MIN_CRITICAL_NEGATIVE]: 400,
  [ErrorCode.MATRIX.MIN_CRITICAL_TOO_HIGH]: 400,
  [ErrorCode.MATRIX.NAME_ALREADY_EXISTS]: 409,
  ...
  // --- EXAM HISTORY ---
  [ErrorCode.EXAM_HISTORY.INVALID_DURATION]: 400,
  [ErrorCode.EXAM_HISTORY.INVALID_SCORE]: 400,
  [ErrorCode.EXAM_HISTORY.USER_ID_REQUIRED]: 400,
  [ErrorCode.EXAM_HISTORY.SNAPSHOT_ID_REQUIRED]: 400,
  [ErrorCode.EXAM_HISTORY.CATEGORY_INFO_REQUIRED]: 400,
  [ErrorCode.EXAM_HISTORY.SCORE_CANNOT_BE_NEGATIVE]: 400,
  [ErrorCode.EXAM_HISTORY.RESULT_STATUS_REQUIRED]: 400,
  [ErrorCode.EXAM_HISTORY.TOTAL_QUESTIONS_INVALID]: 400,
  [ErrorCode.EXAM_HISTORY.SCORE_EXCEEDS_TOTAL]: 400,
  [ErrorCode.EXAM_HISTORY.HISTORY_NOT_FOUND]: 404,

  // STATISTICS
  [ErrorCode.STATISTICS.NOT_FOUND]: 404,
  [ErrorCode.STATISTICS.INVALID_TIME_RANGE]: 400,
  [ErrorCode.STATISTICS.DATA_EMPTY]: 404,
  [ErrorCode.STATISTICS.CALCULATION_ERROR]: 404,

  // --- USER STATISTICS ---
  [ErrorCode.USER_STATS.INVALID_TOTAL_EXAMS]: 400,
  [ErrorCode.USER_STATS.USER_NOT_FOUND]: 404,
  [ErrorCode.USER_STATS.SYNC_FAILED]: 404,

  // --- QUESTION STATISTICS ---
  [ErrorCode.QUESTION_STATS.QUESTION_ID_REQUIRED]: 400,

  [ErrorCode.USER_TOPIC_STATS.TOPIC_ID_REQUIRED]: 400,
  [ErrorCode.USER_TOPIC_STATS.INVALID_COMPLETION_RATE]: 400,
  [ErrorCode.USER_TOPIC_STATS.TOPIC_NOT_FOUND]: 404,
  [ErrorCode.USER_TOPIC_STATS.TOTAL_QUESTIONS_NEGATIVE]: 400,
  [ErrorCode.USER_TOPIC_STATS.WRONG_ANSWERS_EXCEEDS_TOTAL]: 400,
  [ErrorCode.USER_TOPIC_STATS.USER_ID_REQUIRED]: 400,
  [ErrorCode.USER_TOPIC_STATS.RESULTS_REQUIRED]: 400,
  [ErrorCode.USER_TOPIC_STATS.TOPIC_NAME_REQUIRED]: 400,
  [ErrorCode.USER_TOPIC_STATS.CORRECT_STATUS_REQUIRED]: 400,
};
