...
} from "@/application/dtos/response/active-session/active-session.response.dto";
...
export class ActiveSessionMapper {
   ...
   */
  public static toCreateActiveSession(
    entity: ActiveSessionEntity,
  ): IActiveSessionPersistence {
    const { props } = entity;
   ...
   */
  public static toUpdateActiveSession(
    entity: ActiveSessionEntity,
  ): Partial<IActiveSessionPersistence> {
    const { props } = entity;
    return {
