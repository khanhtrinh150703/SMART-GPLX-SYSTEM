...
import { IUserRecord, PrismaUserWithRoles } from "@/infrastructure/persistence/identity/user.record";
...
export class MySQLUserRepository implements IUserRepository {
   ...
   */
  public async updateUser(user: User, tx?: Prisma.TransactionClient): Promise<User> {
  ...
  public async save(user: User): Promise<User> {
    ...
    return existing ? await this.updateUser(user) : await this.createUser(user);
  }
