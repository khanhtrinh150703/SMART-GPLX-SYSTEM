...
export default function SidebarItem({ 
  ...
  return (
    <Link 
      href={href} 
      className={cn(sidebarItemVariants({ status: isActive ? 'active' : 'inactive' }), className)}
    >
      ...
      <div className={cn(
        ...
        isActive ? "text-emerald-400 drop-shadow-[0_0_8px_rgba(52,211,153,0.5)]" : "group-hover:text-emerald-300"
      )}>
        <Icon 
          size={22} 
