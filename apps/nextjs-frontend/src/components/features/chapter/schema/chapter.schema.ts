...
export const createChapterSchema = z.object({
  ...
  orderIndex: z.coerce.number().min(1, "Thứ tự phải lớn hơn 0"), 
});

// Trích xuất Type để dùng cho Form
export type CreateChapterPayload = z.input<typeof createChapterSchema>;
...
export type ChapterEditOutputValues = z.output<typeof chapterEditSchema>;